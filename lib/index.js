...
class Games {
  constructor(data, player) {
    ...
    if (data.wot_RU) this.wot_RU = new WOTRU(data.wot_RU, this);
  }
}
...
class WOTRU{
  ...
  async getStats() {
    let wotRUStats = new WOTRUStats(await this.games.player.faceit.getPlayerStats(this.games.player.id, 'wot_RU'), this);
    this.stats = wotRUStats;
    return wotRUStats;
  }
}
